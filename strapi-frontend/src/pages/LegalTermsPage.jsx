function LegalTermsPage() {
  return (
    <div className='side-padding space-y-10'>
      ...
      <p>
        ...
        <br /> Toutes les photographies et contenus présents sur ce site sont la propriété exclusive
        de Marie ROLLAND. Toute reproduction, modification ou diffusion sans autorisation écrite est
        interdite et constitue une violation du droit d’auteur.
      </p>

      <p>
        <strong>Données personnelles</strong>
        <br /> Les informations collectées via le formulaire de contact sont utilisées uniquement
      ...
      <p>
        ...
        <br /> Ce site n’utilise aucun cookie et ne collecte aucune donnée personnelle à des fins de
        suivi ou d’analyse.
      </p>
    </div>
  );
